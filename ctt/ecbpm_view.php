...
<main class="main users chart-page" id="skip-target">
    <div class="container">
        <!--<h2 class="main-title"><?php echo $row1['ship_name'] ?> (<?php echo $row['name'] ?>) - View CBPM Data</h2>-->
        <div class="row" style="overflow-x:auto; height: 450px; width:100% !important; margin-left:10px; background-color: rgb(0 0 0 / 40%);">        
            ...
            <table border="1" style="border-collapse:collapse;text-align:center; color:#ffffff;">
                <tr>
                    <th colspan="54">
                            ...
                            <center><h3 style="color:#ffffff;">CBPM Reading for the month of <?php echo $month; ?> - <?php echo $year; ?> </h3></center>
                ...
                if($sqlp)
                {
                    ...
                    while($eqptn = mysqli_fetch_assoc($sqlp))
                    {
                        /*$year=$_GET['year'];
                          ...
                          $sqlvc = mysqli_query($db,"select * from cbpm where eqpt_id='$eqpt' and ship_id = '$sid' and year = '$year' and month='$month' ");   
            ...
            <div style="margin:20px;">
                <form action="" method="POST" name="valdt" id="valdt">
                    <input type="hidden" value="<?php echo $year ?>" name="year">
                    <input type="hidden" value="<?php echo $month ?>" name="month">
                    <input type="hidden" value="<?php echo $sid ?>" name="sid">
                    <input class="form-btn primary-default-btn transparent-btn" type="submit" name="valsub" id="valsub" value="Validate"/>
                </form>
            </div>
            <?php
            }
